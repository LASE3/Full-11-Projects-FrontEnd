...
(function () {
  ...
  const crmApp = {
    ...
    initResponsiveLayout: function () {
      ...
      document.querySelectorAll('table.accounts-table, table.data-table, table').forEach(table => {
        if (!table.parentElement.classList.contains('table-responsive') && !table.parentElement.classList.contains('accounts-table-container')) {
