      ...
      <main class="content-wrapper">
        <div class="portal-container">
          ...
          <div class="kpi-grid">
            ...
            <div class="crm-card kpi-card">
              ...
              <div class="kpi-value-row">
                ...
                <span class="crm-text-muted-12" >Achieved</span>
              </div>
              <div class="kpi-footer">
            ...
            <div class="crm-card kpi-card">
              ...
              <div class="kpi-value-row">
                ...
                <span class="crm-text-muted-12" >Probability</span>
              </div>
              <div class="kpi-footer">
          ...
          <div class="crm-card crm-mb-6" >
            ...
            <div class="crm-grid-5col" >
              <!-- Q1 -->
              <div class="crm-panel-steel" >
                <div class="crm-caption-bold" >Q1 2024 Actual</div>
                <div class="crm-mono-stat-xl" >$16.20M</div>
                <div class="crm-text-success-11" >108% of Plan (Settled)</div>
              </div>

              <!-- Q2 -->
              <div class="crm-panel-steel" >
                <div class="crm-caption-bold" >Q2 2024 Actual</div>
                <div class="crm-mono-stat-xl" >$18.10M</div>
                <div class="crm-text-success-11" >102% of Plan (Settled)</div>
              </div>

              <!-- Q3 -->
              <div class="crm-panel-steel" >
                <div class="crm-caption-bold" >Q3 2024 Actual</div>
                <div class="crm-mono-stat-xl" >$19.75M</div>
                <div class="crm-text-success-11" >104% of Plan (Settled)</div>
              </div>

              <!-- Q4 (Projected) -->
              <div class="crm-panel-amber" >
                <div class="crm-caption-amber" >Q4 2024 (Forecast)</div>
                <div class="crm-mono-stat-xl" >$22.50M</div>
                <div class="crm-text-amber-11" >82% Gated ($18.45M)</div>
              </div>

              <!-- Q1 2025 (Pipeline) -->
              <div class="crm-panel-indigo" >
                <div class="crm-caption-indigo" >Q1 2025 (Pipeline)</div>
                <div class="crm-mono-stat-xl" >$25.10M</div>
                <div class="crm-text-indigo-11" >Qualified Backlog</div>
              </div>
            </div>
          </div>
            ...
            <table class="accounts-table">
              ...
              <tbody id="forecast-tbody">
                <tr class="account-row account-row-tagged">
                  <td>
                    <div class="crm-flex-gap-65" >
                      <img class="crm-avatar-32" src="https://lh3.googleusercontent.com/aida-public/AB6AXuDZ9P2QbrRU2xObdFOu9aNA-iyUeUZ6UvBFT0l0KnTu1MKDRX0c84gVy9VkzAjtaXzw0JcEGYWbxd3RDqaIh7AyD6h4njnD-XTgLNnu6wa-UaOplKQCaWIDACINffaFufLMrEaDfvX7J3bqgPCT5b9oY66PI4s0dfAwRgA_V8p0oKzRnCAU0tihwWPq8xzU4FbT1iUoh0cBzt9pq7gPkXJVjA32ZA7kWXQvcLq090IXW-8Ihh_efhmM"  alt="Elena" />
                      <div>
                        <strong>Dr. Elena Rostova</strong>
                        <div class="crm-text-muted-sm" >Lead Technical Director</div>
                      </div>
                    </div>
                  </td>
                  <td>Severstal Metallurgy PJSC, PhosAgro Chemical</td>
                  <td><strong class="crm-mono-navy" >$6,850,000.00</strong></td>
                  <td><span class="crm-mono-muted" >$6,000,000.00</span></td>
                  <td>
                    <div class="crm-flex-gap-sm" >
                      <div class="funnel-bar-track crm-progress-bar-slot" >
                        <div class="funnel-bar-fill crm-w-100-success" ></div>
                      </div>
                      <span class="crm-mono-bold-success" >114%</span>
                    </div>
                  </td>
                  <td><span class="tier-badge crm-badge-success" >✓ Quota Met</span></td>
                </tr>

                <tr class="account-row account-row-tagged">
                  <td>
                    <div class="crm-flex-gap-65" >
                      <img class="crm-avatar-32" src="https://lh3.googleusercontent.com/aida-public/AB6AXuDoVYMImYMOrFG-GImEjxCUij3YIwCjbxiUVg9-84NgNQUnx44rwhCbh4EVKLngwn6R5_hzNhRQkfTglEUz1jtP83GRGR8WbDdiIQblwg1fLV0mqc04y19GGKO27NGBpanqADz4vwO3ANY9KcZiOXBusZHAE_PU_FuuwKqChSLXXJsGo289bHOL3MFrKWoXXMoxnqoUIglg-NYsM99jg8cA3e1CeWhqlY0x7isLHdQfGbcFE_XiNNJg"  alt="Mikhail" />
                      <div>
                  ...
                  <td><strong class="crm-mono-navy" >$8,400,000.00</strong></td>
                  <td><span class="crm-mono-muted" >$8,000,000.00</span></td>
                  <td>
                    <div class="crm-flex-gap-sm" >
                      <div class="funnel-bar-track crm-progress-bar-slot" >
                        <div class="funnel-bar-fill crm-w-100-success" ></div>
                      </div>
                      <span class="crm-mono-bold-success" >105%</span>
                    </div>
                  </td>
                  <td><span class="tier-badge crm-badge-success" >✓ Quota Met</span></td>
                </tr>
                ...
                <tr class="account-row account-row-tagged">
                  <td>
                    <div class="crm-flex-gap-65" >
                      <img class="crm-avatar-32" src="https://lh3.googleusercontent.com/aida-public/AB6AXuDoVYMImYMOrFG-GImEjxCUij3YIwCjbxiUVg9-84NgNQUnx44rwhCbh4EVKLngwn6R5_hzNhRQkfTglEUz1jtP83GRGR8WbDdiIQblwg1fLV0mqc04y19GGKO27NGBpanqADz4vwO3ANY9KcZiOXBusZHAE_PU_FuuwKqChSLXXJsGo289bHOL3MFrKWoXXMoxnqoUIglg-NYsM99jg8cA3e1CeWhqlY0x7isLHdQfGbcFE_XiNNJg"  alt="Viktor" />
                      <div>
                  ...
                  <td><strong class="crm-mono-navy" >$4,200,000.00</strong></td>
                  <td><span class="crm-mono-muted" >$4,500,000.00</span></td>
                  <td>
                    <div class="crm-flex-gap-sm" >
                      <div class="funnel-bar-track crm-progress-bar-slot" >
                        <div class="funnel-bar-fill crm-w-93-amber" ></div>
                      </div>
                      <span class="crm-mono-amber" >93.3%</span>
                    </div>
                  </td>
