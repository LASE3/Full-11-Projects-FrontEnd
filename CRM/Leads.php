          ...
          <div class="kpi-grid">
            <div class="crm-card kpi-card">
              ...
              <div class="kpi-value-row">
                ...
                <span style="font-size: 13px; color: var(--crm-text-muted);">Total</span>
              </div>
            ...
            <div class="crm-card kpi-card">
              ...
              <div class="kpi-value-row">
                ...
                <span style="font-size: 12px; color: var(--crm-text-muted);">Qualified</span>
              </div>
              <div class="kpi-footer">
                <span>Target: &gt;55%</span>
            ...
            <div class="crm-card kpi-card">
              ...
              <div class="kpi-value-row">
                ...
                <span style="font-size: 12px; color: var(--crm-text-muted);">MSK Time</span>
              </div>
              <div class="kpi-footer">
            ...
            <div class="crm-card kpi-card">
              ...
              <div class="kpi-value-row">
                ...
                <span style="font-size: 12px; color: var(--crm-text-muted);">Priority Deals</span>
              </div>
              <div class="kpi-footer">
              ...
              <tbody>
                ...
                <tr class="account-row account-row-tagged">
                  ...
                  <td>
                    ...
                    <div style="font-size: 11px; color: var(--crm-text-muted);">Pipe Rolling Mill #8 · Челябинск</div>
                  </td>
                  <td>
                    <span>Seamless Casing Ultrasonic Flaw Detection Skid</span>
                  </td>
                  <td>
                    <strong style="font-family: var(--crm-font-mono); color: var(--crm-navy);">$1,450,000.00</strong>
                  </td>
                  <td>
                    <span style="font-family: var(--crm-font-mono); font-weight: 700; color: var(--crm-success);">94 / 100</span>
                  </td>
                  <td>
                ...
                <tr class="account-row account-row-tagged">
                  ...
                  <td>
                    ...
                    <div style="font-size: 11px; color: var(--crm-text-muted);">Oxygen Converter Shop #2 · Магнитогорск</div>
                  </td>
                  <td>
                    <span>Multi-Channel Gas Optical Spectrometry Matrix</span>
                  </td>
                  <td>
                    <strong style="font-family: var(--crm-font-mono); color: var(--crm-navy);">$2,280,000.00</strong>
                  </td>
                  <td>
                    <span style="font-family: var(--crm-font-mono); font-weight: 700; color: var(--crm-success);">91 / 100</span>
                  </td>
                  <td>
                ...
                <tr class="account-row account-row-tagged">
                  ...
                  <td>
                    ...
                    <div style="font-size: 11px; color: var(--crm-text-muted);">Ammonia Synthesis Complex · Пермь</div>
                  </td>
                  <td>
                    <span>HPF-900X High Pressure Flowmeters (x24 Unit Batch)</span>
                  </td>
                  <td>
                    <strong style="font-family: var(--crm-font-mono); color: var(--crm-navy);">$620,000.00</strong>
                  </td>
                  <td>
                    <span style="font-family: var(--crm-font-mono); font-weight: 700; color: var(--crm-indigo);">85 / 100</span>
                  </td>
                  <td>
                ...
                <tr class="account-row account-row-tagged">
                  ...
                  <td>
                    ...
                    <div style="font-size: 11px; color: var(--crm-text-muted);">Catalytic Cracking Unit 43-103 · Омск</div>
                  </td>
                  <td>
                    <span>Wireless Vibration Sensor Mesh &amp; IoT Gateways</span>
                  </td>
                  <td>
                    <strong style="font-family: var(--crm-font-mono); color: var(--crm-navy);">$890,000.00</strong>
                  </td>
                  <td>
                    <span style="font-family: var(--crm-font-mono); font-weight: 700; color: var(--crm-success);">88 / 100</span>
                  </td>
                  <td>
                    <span class="tier-badge tier-1">Web RFQ</span>
                  </td>
  ...
  <div id="modal-convert-customer" class="modal-backdrop">
    <div class="modal-card">
      ...
      <div class="modal-body">
        <div style="background: var(--crm-surface-dim); padding: 1rem; border-radius: var(--crm-radius-md); border-left: 4px solid var(--crm-tag-customer);">
          <div style="font-size: 11px; text-transform: uppercase; color: var(--crm-text-muted); font-weight: 600;">Enterprise Account</div>
          <div style="font-size: 15px; font-weight: 700; color: var(--crm-navy);" id="convert-lead-company">Company Name</div>
          <div style="font-size: 12px; color: var(--crm-text-secondary); margin-top: 2px;">Primary Engineer: <strong id="convert-lead-name">Engineer Name</strong></div>
          <div style="font-size: 12px; font-family: var(--crm-font-mono); color: var(--crm-navy); font-weight: 700; margin-top: 4px;">Initial Deal Pipeline: <span id="convert-lead-val">$0.00</span></div>
        </div>
