    ...
    <div class="main-layout">
      ...
      <main class="content-wrapper">
        <div class="portal-container">
          ...
          <div class="fin-card fin-panel-flush-mb" >
            ...
            <table class="fin-table">
              ...
              <tbody id="unmatched-desk-body">
                <?php if (empty($unmatchedWires)): ?>
                  <tr>
                    <td class="fin-empty-state-lg" colspan="6" >
                ...
                <?php else: ?>
                  <?php foreach ($unmatchedWires as $wire): ?>
                    <tr id="tx-row-<?= $wire['payment_id'] ?>" class="fin-table-row">
                      <td>
                        <span class="fin-mono-bold-green" >
            ...
            <table class="fin-table">
              <thead>
                <tr>
                  ...
                  <th>Settled Value</th>
                  <th>Clearing Date</th>
                  <th class="fin-text-right" >Status</th>
                </tr>
              </thead>
              <tbody>
                ...
                <?php else: ?>
                  <?php foreach ($reconciledWires as $rec): ?>
                    <tr class="fin-table-row">
                      <td>
                        <span class="fin-mono-navy-12" >
                          <?= htmlspecialchars($rec['tx_reference']) ?>
                        </span>
                      </td>
                      <td>
                        <div class="fin-semibold-navy" ><?= htmlspecialchars($rec['remitter']) ?></div>
                      </td>
                      <td>
                        <span class="fin-text-secondary-12" ><?= htmlspecialchars($rec['method']) ?></span>
                        <?php if ($rec['remittance_memo']): ?>
                          <div class="fin-mono-muted-105" ><?= htmlspecialchars($rec['remittance_memo']) ?></div>
                        <?php endif; ?>
                      </td>
                      <td>
                        <?php if ($rec['inv_id']): ?>
                          <a href="Invoices.php?search=<?= urlencode($rec['inv_id']) ?>" class="fin-mono-green-link">
                            <?= htmlspecialchars($rec['inv_id']) ?> ↗
                          </a>
                        <?php else: ?>
                          <span class="fin-text-muted-11" >General Balance</span>
                        <?php endif; ?>
                      </td>
                      <td>
                        <span class="fin-mono-bold-navy" >
