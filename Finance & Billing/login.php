  ...
  <script>
    document.addEventListener('DOMContentLoaded', () => {
      ...
      loginForm.addEventListener('submit', (e) => {
        ...
        if (!userId) {
          showAlert('Please enter your Finance Officer ID (e.g. FIN-VP-502).');
          userIdInput.focus();
          return;
        }

        if (!password) {
          showAlert('Please enter your fiscal password.');
          passwordInput.focus();
          return;
        }
        ...
        .then(async (res) => {
          ...
          if (res.ok && data.success) {
            ...
            try {
              ...
              sessionStorage.setItem('vp_finance_user', JSON.stringify(data.user || {
                userId: userId,
