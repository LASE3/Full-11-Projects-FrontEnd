...
<body>
            ...
            <table class="fin-table">
              <thead>
                <tr>
                  ...
                  <th class="fin-text-right" >Annual Budget</th>
                  <th class="fin-text-right" >Expended YTD</th>
                  <th class="fin-w-220" >Burn-Rate Pacing</th>
                  <th class="fin-text-right" >Remaining</th>
              ...
              <tbody>
                <?php if (empty($budgets)): ?>
                  <tr>
                    <td class="fin-empty-state" colspan="7" >
                ...
                <?php else: ?>
                  ...
                  ?>
                    <tr class="fin-table-row">
                      <td>
                        <code class="fin-mono-bold-green" >
                          CC-<?= htmlspecialchars($b['department_code']) ?>
                        </code>
                      </td>
                      <td>
                        <strong><?= htmlspecialchars($b['dept_name']) ?></strong>
                        <div class="fin-text-muted-11" ><?= htmlspecialchars($b['main_function']) ?> · Lead: <?= htmlspecialchars($lead) ?></div>
                      </td>
  ...
  <div id="modal-update-budget" class="modal-backdrop">
    <div class="modal-dialog fin-modal-500" >
      <div class="modal-header">
        <div class="fin-text-bold-14" >Departmental Budget Allocation (Commit to DB)</div>
      ...
      <div class="modal-body">
        <form onsubmit="event.preventDefault(); window.finApp.handleUpdateBudgetSubmit(this);">
          ...
          <div class="fin-flex-col-gap-md" >
            <div>
              <label class="fin-field-label" >Cost Center / Department *</label>
              <select class="fin-form-control" name="department_code" id="edit-dept-code" required >
                <?php foreach ($budgets as $b): ?>
            ...
            <div>
              <label class="fin-field-label" >Allocated Annual Budget (EUR) *</label>
              <input class="fin-form-control" type="number" step="0.01" min="1" name="allocated_amount" id="edit-allocated" required placeholder="3500000.00"  />
            </div>

            <div>
              <label class="fin-field-label" >Expended Amount YTD (EUR) *</label>
              <input class="fin-form-control" type="number" step="0.01" min="0" name="spent_amount" id="edit-spent" required placeholder="2100000.00"  />
            </div>
