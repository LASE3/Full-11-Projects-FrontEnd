...
<head>
  ...
  <title>VOSTOKPRIBOR Finance · Engineering Division Budgets</title>
    ...
    <header class="top-nav">
      ...
      <div class="top-nav__content">
        ...
        <div class="top-nav__actions">
          ...
          <button class="icon-button" onclick="window.finApp.showToast('Budget Alert', 'R&D Labs CapEx utilization at 94.2%.')">
        ...
        <div class="portal-container">
          <div class="page-header">
            <div class="page-header-info">
              ...
              <p class="page-subtitle">Fiscal year 2024 departmental cost centers, laboratory capital expenditure, and burn-rate governance</p>
            </div>
            <div class="page-header-actions">
              <button class="btn btn-outline" onclick="window.finApp.showToast('Budget Approved', 'Q4 Supplementary allocation sent to Board of Governors.')">
                <span>📑 Request Budget Revision</span>
              </button>
            </div>
          </div>
          ...
          <div class="fin-card" style="padding: 0; overflow: hidden;">
            <div style="padding: 1rem 1.25rem; background: #FFFFFF; border-bottom: 1px solid var(--fin-surface-border);">
              <h3 class="card-title">Cost Center Allocations across 8 Engineering Divisions</h3>
            </div>
            <table class="fin-table">
              <thead>
                <tr>
                  <th>Cost Center</th>
                  <th>Engineering Division</th>
              ...
              <tbody>
                <tr>
                  <td><code style="font-family: var(--fin-font-mono); color: var(--fin-green); font-weight: 700;">CC-801</code></td>
                  <td><strong>Optical Sensors Engineering</strong> (Dr. Elena Rostova)</td>
                  <td style="text-align: right; font-family: var(--fin-font-mono); font-weight: 700;">$4,200,000.00</td>
                  <td style="text-align: right; font-family: var(--fin-font-mono); font-weight: 700; color: var(--fin-green);">$3,780,000.00</td>
                  <td>
                    <div class="budget-progress-container">
                      <div class="budget-progress-bar"><div class="budget-progress-fill" style="width: 90%;"></div></div>
                      <div class="budget-progress-meta"><span>90.0%</span><span>On Plan</span></div>
                    </div>
                  </td>
                  <td style="text-align: right; font-family: var(--fin-font-mono);">$420,000.00</td>
                </tr>
                <tr>
                  <td><code style="font-family: var(--fin-font-mono); color: var(--fin-green); font-weight: 700;">CC-802</code></td>
                  <td><strong>SCADA &amp; Automation</strong> (Viktor Morozov)</td>
                  <td style="text-align: right; font-family: var(--fin-font-mono); font-weight: 700;">$3,400,000.00</td>
                  <td style="text-align: right; font-family: var(--fin-font-mono); font-weight: 700; color: var(--fin-green);">$3,060,000.00</td>
                  <td>
                    <div class="budget-progress-container">
                      <div class="budget-progress-bar"><div class="budget-progress-fill" style="width: 90%;"></div></div>
                      <div class="budget-progress-meta"><span>90.0%</span><span>On Plan</span></div>
                  ...
                  <td style="text-align: right; font-family: var(--fin-font-mono);">$340,000.00</td>
                </tr>
                <tr>
                  <td><code style="font-family: var(--fin-font-mono); color: var(--fin-green); font-weight: 700;">CC-803</code></td>
                  <td><strong>R&amp;D Cleanroom &amp; Sensor Fabrication</strong> (Dr. M. Abramov)</td>
                  <td style="text-align: right; font-family: var(--fin-font-mono); font-weight: 700;">$5,600,000.00</td>
                  <td style="text-align: right; font-family: var(--fin-font-mono); font-weight: 700; color: var(--fin-green);">$5,275,000.00</td>
                  <td>
                    <div class="budget-progress-container">
                      <div class="budget-progress-bar"><div class="budget-progress-fill" style="width: 94.2%; background: linear-gradient(90deg, #E8A33D, #F59E0B);"></div></div>
                      <div class="budget-progress-meta"><span>94.2%</span><span style="color: var(--fin-amber-hover);">CapEx High</span></div>
                    </div>
                  </td>
                  <td style="text-align: right; font-family: var(--fin-font-mono);">$325,000.00</td>
                </tr>
              </tbody>
            </table>
          </div>
