<?php
/**
 * VOSTOKPRIBOR Finance & Billing (SYS07) - Inter-System Integrations & Data Bus
...
<head>
    ...
    <title>VOSTOKPRIBOR Finance & Billing · Inter-System Integrations (SYS07)</title>
...
<body>
    ...
    <header class="vostok-top-bar">
        <a href="Dashboard.php" class="vostok-brand-link">
            ...
            <div style="display: flex; flex-direction: column;">
                ...
                <span style="font-family: 'JetBrains Mono', monospace; font-size: 0.65rem; color: #00E5FF;">Finance & Billing &bull; SYS07</span>
            </div>
        </a>
        ...
        <div class="vostok-nav-actions">
            ...
            <a href="../api/logout.php?redirect=../Finance & Billing/login.php" class="vostok-btn-back" style="color: #F87171; border-color: rgba(239,68,68,0.3);">
    ...
    <main class="vostok-main-content">
        <?php renderSystemIntegrationView('SYS07', 'standalone'); ?>
    </main>
