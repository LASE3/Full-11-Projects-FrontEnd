    ...
    <header class="vostok-top-bar">
        <a href="Dashboard.php" class="vostok-brand-link">
            ...
            <div class="vostok-brand-title">
                ...
                <span class="vostok-brand-system">Finance & Billing &bull; SYS07</span>
            </div>
        </a>
        ...
        <div class="vostok-nav-actions">
            ...
            <a href="../api/logout.php?redirect=../Finance & Billing/login.php" class="vostok-btn-back vostok-btn-signout">
