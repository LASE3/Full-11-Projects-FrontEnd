            ...
            <table class="fin-table">
              <thead>
                <tr>
                  ...
                  <th style="width: 220px;">Billed vs Budget</th>
                  <th style="width: 220px;">Next Scheduled Milestone</th>
              ...
              <tbody>
                <?php if (empty($projects)): ?>
                  <tr>
                    <td colspan="8" style="text-align: center; padding: 2rem; color: var(--fin-text-muted);">
                ...
                <?php else: ?>
                  ...
                  ?>
                    <tr class="fin-table-row">
                      ...
                      <td>
                        <div style="font-weight: 700; color: var(--fin-navy);"><?= htmlspecialchars($prj['project_name']) ?></div>
                        <div style="font-size: 11px; color: var(--fin-text-muted);"><?= htmlspecialchars($prj['company_name']) ?> · Sector: <?= htmlspecialchars($prj['sector'] ?? 'Industrial') ?></div>
                      </td>
                      ...
                      <td>
                        ...
                        <?php else: ?>
                          <span style="font-size: 11px; color: var(--fin-text-muted);">All Milestones Billed ✓</span>
                        <?php endif; ?>
                      </td>
  ...
  <div id="modal-bill-milestone" class="modal-backdrop">
    <div class="modal-dialog" style="max-width: 550px;">
      <div class="modal-header">
        <div style="font-weight: 700; font-size: 14px;">Bill Project Milestone (Generates Invoice in DB)</div>
      ...
      <div class="modal-body">
        <form onsubmit="event.preventDefault(); const cid = document.getElementById('select-milestone-cycle').value; window.finApp.billMilestone(cid);">
          <div style="display: flex; flex-direction: column; gap: 1rem;">
            <div>
              <label style="display: block; font-size: 11.5px; font-weight: 600; color: var(--fin-navy); margin-bottom: 0.25rem;">Select Unbilled Milestone from DB *</label>
              <select id="select-milestone-cycle" required style="width: 100%; padding: 0.55rem; border: 1px solid var(--fin-surface-border); border-radius: var(--fin-radius-md); font-size: 13px;">
            ...
            <div style="font-size: 12px; color: var(--fin-text-secondary); background: var(--fin-surface-dim); padding: 0.85rem; border-radius: var(--fin-radius-sm); border-left: 3px solid var(--fin-green);">
