<?php
/**
 * VOSTOKPRIBOR Admin & Governance Portal (SYS01) - Inter-System Integrations & Data Bus
...
<head>
    ...
    <title>VOSTOKPRIBOR Admin & Governance Portal · Inter-System Integrations (SYS01)</title>
...
<body>
    ...
    <header class="vostok-top-bar">
        <a href="mainDashboard.php" class="vostok-brand-link">
            ...
            <div style="display: flex; flex-direction: column;">
                ...
                <span style="font-family: 'JetBrains Mono', monospace; font-size: 0.65rem; color: #00E5FF;">Admin & Governance Portal &bull; SYS01</span>
            </div>
        </a>

        <div class="vostok-nav-actions">
            <a href="mainDashboard.php" class="vostok-btn-back">
                <span class="material-symbols-outlined" style="font-size: 1rem;">arrow_back</span>
                <span>Back to Dashboard</span>
            </a>
            <a href="../api/logout.php?redirect=../Admin & Governance Portal/login.php" class="vostok-btn-back" style="color: #F87171; border-color: rgba(239,68,68,0.3);">
