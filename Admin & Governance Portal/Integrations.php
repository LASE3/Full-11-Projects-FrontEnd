    ...
    <header class="vostok-top-bar">
        <a href="mainDashboard.php" class="vostok-brand-link">
            ...
            <div class="vostok-brand-title">
                ...
                <span class="vostok-brand-system">Admin & Governance Portal &bull; SYS01</span>
            </div>
        </a>
        ...
        <div class="vostok-nav-actions">
            ...
            <a href="../api/logout.php?redirect=../Admin & Governance Portal/login.php" class="vostok-btn-back vostok-btn-signout">
