                ...
                <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-space-md mb-space-lg">
                    ...
                    <div
                        ...
                        <div class="pl-space-xs pt-space-md pb-space-xs flex items-baseline gap-space-xs">
                            ...
                            <span class="font-telemetry-micro text-telemetry-micro text-secondary font-semibold">–² +0.4%
                                Target: 95.0%</span>
                        </div>
                        <div
                            ...
                            <span>28/29 Mandated Compliant</span>
                            <span class="text-tertiary font-medium">1 In Remediation</span>
                        </div>
                    </div>
