...
(function () {
      ...
      if (mapItem) {
        ...
        if (isCurrent) {
          ...
          if (mapItem.isEmergency) {
            link.className =
              "flex items-center justify-between px-space-sm py-space-xs rounded bg-error-container text-on-error-container font-semibold shadow-sm transition-all font-body-compact text-body-compact border-l-4 border-error";
          } else {
            link.className =
              "flex items-center justify-between px-space-sm py-space-xs rounded transition-all bg-primary-container text-on-primary font-semibold border-l-4 border-secondary-fixed shadow-sm font-body-compact text-body-compact";
          }
        } else {
          link.removeAttribute("aria-current");
          if (mapItem.isEmergency) {
            link.className =
              "flex items-center justify-between px-space-sm py-space-xs rounded text-error hover:bg-error-container hover:text-on-error-container transition-all font-body-compact text-body-compact";
          } else {
            link.className =
              "flex items-center justify-between px-space-sm py-space-xs rounded text-on-primary-container hover:bg-primary-container hover:text-on-primary transition-all font-body-compact text-body-compact";
          }
        }
      }
    });
  ...
  window.showToast = function (
    ...
    if (type === "success" || type === true)
      resolvedIcon = iconName || "check_circle";
    if (type === "error" || type === false) resolvedIcon = iconName || "error";
    if (type === "warn" || type === "warning")
      resolvedIcon = iconName || "warning";
  ...
  const SEARCH_ENTITIES = [
    ...
    {
      name: "Access Matrix & Role Entitlement Configurator",
      path: "accessMatrix.php",
      type: "View",
      cat: "Identity",
    },
    {
      name: "Privileged Accounts & Vault Session Control",
      path: "PrivilegedAccounts.php",
      type: "View",
      cat: "Vault",
    },
    {
      name: "Audit Logs & Streaming Event Inspection",
      path: "AuditLogs.php",
      type: "View",
      cat: "Audit",
    },
    {
      name: "Telemetry Ingestion Bridges (SYS 01-10)",
      path: "IngestionBridges.php",
      type: "View",
      cat: "Pipelines",
    },
    {
      name: "Break-Glass Emergency HSM Override",
      path: "Break-GlassAccess.php",
      type: "View",
      cat: "Emergency",
    },
    {
      name: "Enterprise Security Policies (DOC-2026-001)",
      path: "SecurityPolicies.php",
      type: "View",
      cat: "Policies",
    },
    {
      name: "Board Risk Register & Roadmap (DOC-2026-015)",
      path: "BoardRiskRegister.php",
      type: "View",
      cat: "Board",
    },
    {
      name: "Compliance Oversight & Statutory Register",
      path: "ComplianceOversight.php",
      type: "View",
      cat: "Compliance",
    },
    {
    ...
    {
      name: "Corporate Web Platform (System 01 // Public)",
      path: "../VOSTOKPRIBOR Corporate Web Platform/index.php",
      type: "External",
      cat: "Ecosystem",
    },
    {
      name: "B2B Online Shop (System 02 // Commerce)",
      path: "../Online Shop B2B/index.php",
      type: "External",
      cat: "Ecosystem",
    },
    {
      name: "Customer Service Portal (System 03 // Client)",
      path: "../Customer Portal/Dashboard.php",
      type: "External",
      cat: "Ecosystem",
    },
    {
    ...
    {
      name: "CRM Platform (System 05 // Sales)",
      path: "../CRM/index.php",
      type: "External",
      cat: "Ecosystem",
    },
    {
      name: "Human Resources HR (System 06 // Personnel)",
      path: "../HR System/index.php",
      type: "External",
      cat: "Ecosystem",
    },
    {
      name: "Finance & Billing (System 07 // Treasury)",
      path: "../Finance & Billing/index.php",
      type: "External",
      cat: "Ecosystem",
    },
    {
      name: "IT Helpdesk & Operations (System 08 // Service)",
      path: "../IT Helpdesk/index.php",
      type: "External",
      cat: "Ecosystem",
    },
    {
    ...
    {
      name: "DOC-2026-004 BaltNord Integration Spec (System 09)",
      path: "../File Center/approvals.php",
      type: "Doc",
      cat: "File Center",
    },
    {
      name: "Developer & API Portal (System 10 // Cyan)",
      path: "../Developer/index.php",
      type: "External",
      cat: "Developer",
    },
    {
      name: "DOC-2026-010 API Integration Guide (System 10)",
      path: "../Developer/guides.php",
      type: "Doc",
      cat: "Developer",
    },
    // Statutory Baseline Documents
    {
      name: "DOC-2026-001 Corporate Information Security Policy",
      path: "SecurityPolicies.php",
      type: "Doc",
      cat: "Classified",
    },
    ...
    {
      name: "DOC-2026-015 Board Risk Register 2026",
      path: "BoardRiskRegister.php",
      type: "Doc",
      cat: "Classified",
    },
  ...
  function createSearchModal() {
    ...
    modal.className =
      "fixed inset-0 z-50 hidden bg-primary/70 backdrop-blur-sm flex items-start justify-center pt-24 p-4";
    modal.innerHTML = `
    ...
    function renderResults(query) {
      ...
      const filtered = SEARCH_ENTITIES.filter(
        (item) =>
          q === "" ||
      ...
      if (filtered.length === 0) {
        resultsBox.innerHTML =
          '<div class="p-4 text-center text-on-surface-variant">No matching governance entities found.</div>';
        return;
      }
      ...
      filtered.forEach((item) => {
        ...
        row.href = item.path;
        row.className =
          "flex items-center justify-between p-2 hover:bg-primary-container/20 rounded transition-colors cursor-pointer text-on-surface group";
        row.innerHTML = `
  ...
  function initResponsiveLayout() {
    ...
    const headerLeft = header
      ? header.querySelector(".flex.items-center:first-child")
      : null;
