                    ...
                    <div class="notifications-popover" id="notifications-popover" style="width: 20rem; right: 0;">
                        ...
                        <div style="max-height: 18rem; overflow-y: auto;">
                            <div style="padding: 0.75rem 1rem; border-bottom: 1px solid rgba(255,255,255,0.06); display: flex; gap: 0.75rem;">
                                ...
                                <div>
                                    <div style="font-size: 0.8125rem; font-weight: 600; color: #FFFFFF;">Policy Revision Released</div>
                                    <div style="font-size: 0.75rem; color: #939FA8; margin-top: 2px;">DOC-2026-007 Cryptographic Matrix v3.0 approved.</div>
                                    <div style="font-size: 0.6875rem; color: #5C7290; margin-top: 4px; font-family: var(--font-mono);">1h ago</div>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <aside class="intranet-sidebar" id="intranet-sidebar">
        ...
        <div style="padding-top: 1rem; display: flex; flex-direction: column; gap: 0.25rem;">
            ...
            <a href="EmployeeDirectory.php" class="sidebar-link">
                ...
                <span class="sidebar-badge" style="margin-left: auto; background: rgba(92,114,144,0.3); color: #BDC6CF; font-family: var(--font-mono); font-size: 0.6875rem; padding: 0.1rem 0.4rem; border-radius: 999px;">95</span>
            </a>
    ...
    <main class="intranet-content-wrapper" id="intranet-content-wrapper">
        <div style="padding: 1.5rem; max-width: 86rem; margin: 0 auto;">
            ...
            <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 1.25rem; flex-wrap: wrap; gap: 1rem;">
                <div>
                    <div style="display: flex; align-items: center; gap: 0.5rem; font-size: 0.75rem; font-family: var(--font-mono); color: var(--neutral-600); margin-bottom: 0.25rem;">
                        <span>INTRANET</span>
                        <span>/</span>
                        <span style="color: var(--system-accent); font-weight: 600;">POLICIES & FORMS</span>
                    </div>
                ...
                <div style="display: flex; align-items: center; gap: 0.75rem;">
                    ...
                    <button type="button" class="btn btn-primary" onclick="window.showIntranetToast('Document Submission', 'Upload portal active for L3/L4 clearance holders.', 'info')" style="display: inline-flex; align-items: center; gap: 0.375rem;">
            ...
            <!-- ==============================================================
                 ...
                 ============================================================== -->
            <div style="display: grid; grid-template-columns: 1fr; gap: 1.5rem;" class="policy-layout-grid">
                ...
                <div class="intranet-card" style="padding: 1rem;">
                    <div style="font-size: 0.75rem; font-family: var(--font-mono); font-weight: 600; color: var(--neutral-600); text-transform: uppercase; margin-bottom: 0.75rem; padding-left: 0.5rem;">
                        DOCUMENT CATEGORIES
                    </div>
                    ...
                    <div style="display: flex; flex-direction: column; gap: 0.25rem;">
                        <div class="policy-category-item active" data-category="all">
                            ...
                            <span style="font-family: var(--font-mono); font-size: 0.6875rem; color: var(--neutral-500);">15</span>
                        </div>
                        <div class="policy-category-item" data-category="security">
                            <span>Security & Cyber</span>
                            <span style="font-family: var(--font-mono); font-size: 0.6875rem; color: var(--neutral-500);">4</span>
                        </div>
                        <div class="policy-category-item" data-category="hr">
                            <span>HR Policies</span>
                            <span style="font-family: var(--font-mono); font-size: 0.6875rem; color: var(--neutral-500);">3</span>
                        </div>
                        <div class="policy-category-item" data-category="it">
                            <span>IT Standards</span>
                            <span style="font-family: var(--font-mono); font-size: 0.6875rem; color: var(--neutral-500);">2</span>
                        </div>
                    ...
                    <div style="margin-top: 1.5rem; padding: 0.875rem; background: var(--neutral-50); border: 1px solid var(--neutral-200); border-radius: var(--radius-sm); font-size: 0.75rem;">
                        <div style="font-weight: 600; color: var(--neutral-800); margin-bottom: 0.25rem; display: flex; align-items: center; gap: 0.35rem;">
                            <span class="material-symbols-outlined" style="font-size: 1rem; color: var(--system-accent);">verified_user</span>
                            Audit Integrity
                        </div>
                        <p style="margin: 0; color: var(--neutral-600); line-height: 1.4;">
                ...
                <div class="intranet-card" style="padding: 1.25rem;">
                    ...
                    <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 1.25rem; gap: 1rem; flex-wrap: wrap;">
                        <div style="position: relative; flex: 1; max-width: 28rem;">
                            <span class="material-symbols-outlined" style="position: absolute; left: 0.75rem; top: 50%; transform: translateY(-50%); color: var(--neutral-500); font-size: 1.15rem;">search</span>
                            <input type="text" id="policy-search-input" class="form-input" placeholder="Filter documents by ID, title, author, or keyword..." style="padding-left: 2.25rem;">
                        </div>
                    ...
                    <div style="overflow-x: auto;">
                        <table class="table-classified" style="width: 100%; border-collapse: collapse; text-align: left;">
                            <thead>
                                <tr style="border-bottom: 2px solid var(--neutral-200); font-size: 0.6875rem; font-family: var(--font-mono); color: var(--neutral-600); text-transform: uppercase;">
                                    <th style="padding: 0.75rem 1rem;">DOC ID</th>
                                    <th style="padding: 0.75rem 0.75rem;">TITLE & AUTHOR</th>
                                    <th style="padding: 0.75rem 0.75rem;">CATEGORY</th>
                                    <th style="padding: 0.75rem 0.75rem;">CLASSIFICATION</th>
                                    <th style="padding: 0.75rem 0.75rem;">UPDATED</th>
                                    <th style="padding: 0.75rem 0.75rem;">SIZE</th>
