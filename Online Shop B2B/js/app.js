...
(function () {
  ...
  const CUSTOMERS = [
    { id: 'CUS-1005', name: 'Tashkent Precision Controls', sector: 'Manufacturing', contact: 'Dilshod Karim', accountMgr: 'EMP-1008', tier: 'Enterprise Tier A (12% Disc)' },
    { id: 'CUS-1001', name: 'Aral Geomatics Group', sector: 'Geomatics & GIS', contact: 'Sergei Makarov', accountMgr: 'EMP-1007', tier: 'Enterprise Tier A (12% Disc)' },
    { id: 'CUS-1002', name: 'BaltNord Process Systems', sector: 'Process Automation', contact: 'Kristaps Ozols', accountMgr: 'EMP-1010', tier: 'Strategic Partner (15% Disc)' },
    { id: 'CUS-1003', name: 'Steppe Mining Technologies', sector: 'Mining', contact: 'Yerlan Bektemis', accountMgr: 'EMP-1008', tier: 'Enterprise Tier B (8% Disc)' },
    { id: 'CUS-1004', name: 'RheinWerk Instrumentation', sector: 'Industrial Metrology', contact: 'Lukas Brandt', accountMgr: 'EMP-1010', tier: 'Standard Corporate' },
    { id: 'CUS-1007', name: 'Caspian Industrial Robotics', sector: 'Robotics', contact: 'Murad Safarov', accountMgr: 'EMP-1009', tier: 'Strategic Partner (15% Disc)' },
    { id: 'CUS-1008', name: 'Eurasia Water Automation', sector: 'Water Infrastructure', contact: 'Oleg Petrenko', accountMgr: 'EMP-1009', tier: 'Enterprise Tier B (8% Disc)' },
    { id: 'CUS-1010', name: 'CentralRail Diagnostics', sector: 'Railway Infrastructure', contact: 'Tomas Varga', accountMgr: 'EMP-1006', tier: 'Strategic Partner (15% Disc)' }
  ];
  ...
  const PRODUCTS = [
    {
      ...
      tagline: 'Multi-spectral 4K CMOS industrial inspection sensor with sapphire window',
      ...
      specs: [
        { name: 'Optical Resolution', value: '4K CMOS Matrix (3840 x 2160 px, 60fps)' },
        { name: 'Spectral Waveband', value: '400 nm – 1050 nm (VIS-NIR Dual-Spectrum)' },
        { name: 'Field of View (FOV)', value: '68° Diagonal, Fixed F/1.4 Sapphire Lens' },
        { name: 'Precision Tolerance', value: '±0.005 mm at 1.5m focal depth' },
        { name: 'Interface Protocols', value: 'Modbus RTU, Profinet, RS-485, GigE Vision' },
        { name: 'Ingress Protection', value: 'IP68 Hermetic (Submersible 2m / NEMA 6P)' },
        { name: 'Operating Temp', value: '-40°C to +85°C Industrial Extended' },
        { name: 'Power Requirements', value: '24V DC ±10%, 4.8W max consumption' },
        { name: 'MTBF (Reliability)', value: '140,000 Hours (MIL-HDBK-217F Standard)' },
        { name: 'Calibration Cert', value: 'ISO/IEC 17025:2017 Factory Traceable' }
      ],
    ...
    },
    {
      ...
      tagline: 'High-precision dual-frequency GNSS/LiDAR positioning system for harsh topography',
      ...
      specs: [
        { name: 'LiDAR Measurement Range', value: '0.05 m to 250 m (Phase-Shift Coherent)' },
        { name: 'Angular Precision', value: '0.5 arcsec (0.15 mgon)' },
        { name: 'GNSS Constellations', value: 'GPS, GLONASS, Galileo, BeiDou Quad-Band' },
        { name: 'Ingress Protection', value: 'IP67 Dust & Heavy Jet Proof' },
        { name: 'Interface', value: 'CANopen, Bluetooth LE 5.2, USB-C Heavy-Duty' },
        { name: 'Battery Operating Time', value: '22 hrs continuous (Dual Hot-Swap LiFePO4)' },
    ...
    },
    {
      ...
      tagline: 'Multi-channel environmental sensor verification & recalibration test bench',
      ...
      specs: [
        { name: 'Test Channel Capacity', value: '8 Independent Sensor Test Bays (Simultaneous)' },
        { name: 'Thermal Testing Chamber', value: '-50°C to +150°C Automated PID Profile' },
        { name: 'Pressure Reference', value: '0 to 600 Bar (±0.01% FS Accuracy)' },
        { name: 'Interface & Bus', value: 'SCADA OPC-UA, Modbus TCP, REST API Node' },
        { name: 'Enclosure Rating', value: 'IP54 Heavy Industrial Control Rack / NEMA 12' },
    ...
    },
    {
      ...
      tagline: 'High-availability deterministic controller with dual-redundant fieldbus bridge',
      ...
      imageType: 'plc_unit',
      specs: [
        { name: 'Processor', value: 'Quad-Core ARM Cortex-A72 Real-Time Dual Kernel' },
        { name: 'I/O Channels', value: '64 Digital In, 32 Relay Out, 16 Fast Analog (16-bit)' },
        { name: 'Fieldbus Protocols', value: 'Profinet IRT, EtherCAT, Modbus TCP, MQTT-TLS' },
        { name: 'Redundancy', value: 'Hot-Standby Dual Controller (<2ms failover)' },
        { name: 'Mounting & Form', value: 'DIN-Rail TS35 Aluminum Anodized Shield' },
    ...
    },
    {
      ...
      tagline: 'Cellular/Satellite edge telemetry node with isolated industrial sensor interfaces',
      ...
      specs: [
        { name: 'Cellular & Satcom', value: '5G / LTE Cat-M1 + Satellite Iridium Fallback' },
        { name: 'Local I/O', value: 'Dual GigE, RS-485 Galvanic Isolated, 4x 4-20mA' },
        { name: 'Edge Inference', value: 'TensorFlow Lite Embedded Edge Runtime' },
        { name: 'Power Input', value: '9-36V DC Solar/Battery + IEEE 802.3at PoE' },
    ...
    },
    {
      ...
      tagline: 'High-speed triple-camera line scan system with AI surface anomaly classifier',
      category: 'Optical Sensors',
      categorySlug: 'optical-sensors',
      ...
      specs: [
        { name: 'Camera Array', value: 'Triple Telecentric 25MP Global Shutter CoaXPress' },
        { name: 'Illumination', value: 'Programmable Dome & Coaxial Structured LED Ring' },
        { name: 'Throughput', value: 'Up to 1,200 parts / minute at 100% inspection' },
        { name: 'Defect Resolution', value: 'Down to 0.1 µm scratch / crack discrimination' },
        { name: 'AI Inference Node', value: 'NVIDIA Jetson AGX Orin Industrial Embedded' },
    ...
    },
    {
      ...
      tagline: '24/7/365 telemetry monitoring, critical emergency SLA, and firmware security maintenance',
      category: 'Monitoring Gateways',
      categorySlug: 'monitoring-gateways',
      ...
      specs: [
        { name: 'Remote Monitoring', value: '24/7/365 Real-Time Telemetry & Alert Escalation' },
        { name: 'Emergency SLA', value: '1-Hour Maximum Critical Response (TKT Escalation)' },
        { name: 'Firmware & Patches', value: 'Quarterly Over-the-Air Hardened Security Updates' },
        { name: 'Advance Spares', value: 'Next-Business-Day Advance Hardware Replacement' }
      ],
    ...
    },
    {
      ...
      tagline: 'Custom SCADA/MES middleware connectors and REST/GraphQL ERP integration bridge',
      category: 'PLC Integration',
      categorySlug: 'plc-integration',
      ...
      specs: [
        { name: 'Integration Architecture', value: 'Enterprise SCADA & MES Middleware Connector' },
        { name: 'ERP Bridges', value: 'Bi-directional SAP, Oracle NetSuite, 1C Sync' },
        { name: 'Deployment Format', value: 'Containerized Docker/K8s or Bare-Metal Windows/Linux' },
        { name: 'Governance & Security', value: 'RBAC, TLS 1.3, Detailed Audit Log Streaming' }
      ],
    ...
    },
    {
      ...
      tagline: 'Multi-modal cargo fleet telemetry, customs clearance, and waybill tracking portal',
      category: 'Monitoring Gateways',
      categorySlug: 'monitoring-gateways',
      ...
      specs: [
        { name: 'Asset Fleet Tracking', value: 'Real-time GPS/GLONASS Telemetry for 250+ Vehicles' },
        { name: 'Cold-Chain Monitoring', value: 'Temperature, Humidity, & Shock G-Force Logging' },
        { name: 'Waybill Automation', value: 'Automated Customs & Dispatch Document Generation' }
      ],
    ...
    },
    {
      ...
      tagline: 'Quarterly on-site calibration, optical seal maintenance, and ISO 17025 certification',
      category: 'Calibration Stations',
      categorySlug: 'calibration-stations',
      ...
      specs: [
        { name: 'Field Inspection Visits', value: 'Quarterly On-Site Metrology Calibration & Clean-Room Test' },
        { name: 'Certification Standard', value: 'Traceable ISO/IEC 17025 Calibration Reports' },
        { name: 'Consumables Included', value: 'Optical Sapphire Gaskets, Connectors & O-Rings Replaced' }
      ],
  ...
  const ORDERS = [
    {
      ...
      history: [
        ...
        { step: 'Procurement', time: '2026-09-04 11:15 UTC', desc: 'Components requisition approved by Operations (EMP-1013 Ilona Vetra).' },
        { step: 'Fulfillment', time: '2026-09-08 16:40 UTC', desc: 'Hardware staging, calibration bench pass, and ISO 17025 seal applied.' },
        { step: 'Shipped', time: '2026-09-10 14:00 UTC', desc: 'Dispatched via Express Rail Cargo #VP-EXP-992014-KZ. Customs manifest cleared.' },
        { step: 'Delivered', time: 'Expected 2026-09-12', desc: 'Delivery in progress to Tashkent Manufacturing Facility #2.' }
      ]
    },
    {
      id: 'ORD-2026-001',
      ...
      history: [
        ...
        { step: 'Procurement', time: '2026-09-03 14:00 UTC', desc: 'Geodetic LiDAR components cleared from Central Stock.' },
        { step: 'Fulfillment', time: '2026-09-07 10:20 UTC', desc: 'Pre-shipment optical test passed. Firmware version v4.12.0 flashed.' },
        { step: 'Shipped', time: 'Pending Dispatch', desc: 'Scheduled for logistics convoy on 2026-09-14.' },
        { step: 'Delivered', time: 'Expected 2026-09-18', desc: 'Aral Geomatics Central Lab, Kyzylorda.' }
      ]
    },
    {
      id: 'ORD-2026-002',
      ...
      history: [
        ...
        { step: 'Procurement', time: '2026-09-09 11:00 UTC', desc: 'Specialized thermal chambers ordered from precision engineering partner.' },
        { step: 'Fulfillment', time: 'Pending Assembly', desc: 'Staging scheduled at Almaty Workshop Bay 02.' },
        { step: 'Shipped', time: 'Estimated 2026-09-24', desc: 'International road transport to Riga, Latvia.' },
        { step: 'Delivered', time: 'Estimated 2026-09-28', desc: 'BaltNord Process Systems Industrial Park.' }
      ]
    },
    {
      id: 'ORD-2026-003',
      ...
      history: [
        ...
        { step: 'Procurement', time: '2026-08-28 12:00 UTC', desc: 'Ruggedized IP67 components reserved in batch.' },
        { step: 'Fulfillment', time: '2026-09-06 09:15 UTC', desc: 'Vibration & shock tolerance stress testing completed successfully.' },
        { step: 'Shipped', time: 'Pending Dispatch', desc: 'Scheduled for heavy off-road transport to Karaganda Pit #3.' },
        { step: 'Delivered', time: 'Estimated 2026-09-22', desc: 'Steppe Mining Central Equipment Depot.' }
      ]
    },
    {
      id: 'ORD-2026-004',
      ...
      history: [
        ...
        { step: 'Procurement', time: '2026-09-02 09:00 UTC', desc: 'Custom optical prisms sourced and aligned.' },
        { step: 'Fulfillment', time: '2026-09-07 15:30 UTC', desc: 'Clean-room packaging and inert nitrogen sealing.' },
        { step: 'Shipped', time: '2026-09-09 18:00 UTC', desc: 'Air cargo flight departed Almaty International Airport.' },
        { step: 'Delivered', time: 'Estimated 2026-09-14', desc: 'RheinWerk Metrology Facility, Munich.' }
      ]
    },
    {
      id: 'ORD-2026-007',
      ...
      history: [
        ...
        { step: 'Procurement', time: '2026-08-14 11:00 UTC', desc: 'High-speed fieldbus interfaces prepared.' },
        { step: 'Fulfillment', time: '2026-08-22 17:00 UTC', desc: 'Factory Acceptance Test (FAT) passed 100%.' },
        { step: 'Shipped', time: '2026-08-27 10:00 UTC', desc: 'Dispatched across Caspian shipping corridor.' },
        { step: 'Delivered', time: '2026-09-01 16:30 UTC', desc: 'Site Acceptance Test (SAT) signed by Murad Safarov.' }
      ]
    },
    {
      id: 'ORD-2026-008',
      ...
      history: [
        ...
        { step: 'Procurement', time: '2026-09-10 11:30 UTC', desc: 'Cellular eSIMs and satellite transceivers allocated.' },
        { step: 'Fulfillment', time: 'Scheduled for 2026-09-16', desc: 'IP67 enclosure pressure testing in water tank.' },
        { step: 'Shipped', time: 'Estimated 2026-09-25', desc: 'Regional delivery across 12 pump substations.' },
        { step: 'Delivered', time: 'Estimated 2026-09-30', desc: 'Eurasia Water Automation Central Control, Astana.' }
      ]
    }
  ];
  ...
  function getFilteredProducts() {
    return PRODUCTS.filter(product => {
      ...
      if (state.searchTerm) {
        ...
        if (!matchTitle && !matchSku && !matchId && !matchDesc && !matchCat) return false;
      }
      ...
      if (state.selectedSectors.length > 0) {
        ...
        const hasMatchingSector = state.selectedSectors.some(sec => productSectors.includes(sec));
        if (!hasMatchingSector) return false;
      }

      // Availability filter
      if (state.selectedAvailabilities.length > 0) {
        if (!state.selectedAvailabilities.includes(product.availability)) return false;
      }

      // Billing Model filter
      if (state.selectedBillingModels.length > 0) {
        if (!state.selectedBillingModels.includes(product.billingModel)) return false;
      }
      ...
      if (state.sortBy === 'availability') return a.availability.localeCompare(b.availability);
      return 0; // default
    });
  }
  ...
  function renderCatalog() {
    ...
    gridContainer.innerHTML = filtered.map(product => {
      ...
      const keySpecs = product.specs.slice(0, 3).map(s => `<span class="spec-pill">${s.name}: ${s.value.split('(')[0].trim()}</span>`).join('');
  ...
  function renderProductDetail(productId) {
    ...
    const volumeTiersHtml = product.volumePricing ? product.volumePricing.map((tier, idx) => `
    ...
    const relatedServices = PRODUCTS.filter(p => ['PROD-1008', 'PROD-1007', 'PROD-1010'].includes(p.id));

    const relatedCardsHtml = relatedServices.map(srv => `
  ...
  function renderTrackingDashboard() {
    const selectedOrder = ORDERS.find(o => o.id === state.selectedTrackingOrderId) || ORDERS[0];
    const timelineContainer = document.getElementById('tracking-timeline-container');
    const tableContainer = document.getElementById('tracking-orders-table-body');
    const orderSelectEl = document.getElementById('tracking-order-select');

    if (orderSelectEl) {
      orderSelectEl.innerHTML = ORDERS.map(o => `
    ...
    if (timelineContainer) {
      ...
      const stepsHtml = steps.map((step, idx) => {
        ...
        const histItem = selectedOrder.history.find(h => h.step === step.key) || { time: 'Pending', desc: '' };
  ...
  function openRfqDrawer() {
    ...
    if (listEl) {
      if (state.quoteItems.length === 0) {
        ...
        listEl.innerHTML = state.quoteItems.map(item => `
  ...
  function openCartDrawer() {
    ...
    if (listEl) {
      if (state.cartItems.length === 0) {
        ...
        listEl.innerHTML = state.cartItems.map(item => `
          <div class="drawer-item-card">
            <div class="drawer-item-info">
              <span class="drawer-item-sku">${item.id} · ${item.sku}</span>
  ...
  function closeAllModals() {
    document.querySelectorAll('.drawer-container').forEach(d => d.classList.remove('open'));
    const overlay = document.getElementById('modal-overlay');
  ...
  window.shopApp = {
    ...
    submitPdpQuote: function (productId) {
      ...
      updateBadgeCounts();
      showToast(`Added ${qty}x "${product.name}" to Official Quote RFQ`, 'teal');
      openRfqDrawer();
    },
    ...
    selectTrackingOrder: function (orderId) {
      ...
      showToast(`Loaded Live Telemetry & Timeline for Order ${orderId}`, 'teal');
    },
    ...
    downloadDoc: function (docId, type) {
      showToast(`Generating certified PDF Package for ${docId} (${type})...`, 'teal');
      setTimeout(() => {
        showToast(`Document ${docId} retrieved from File Center (System 09)`, 'green');
      }, 1200);
    },
    ...
    selectCustomer: function (customerId) {
      ...
      showToast(`Switched active corporate account to: ${cust.name} (${cust.tier})`, 'green');
    ...
    submitDirectPO: function () {
      const poNumber = document.getElementById('po-number-input')?.value || `PO-VP-${Math.floor(1000 + Math.random() * 9000)}`;
      showToast(`Purchase Order ${poNumber} submitted! Invoice and Statement of Work logged to Finance (System 07).`, 'green');
      state.cartItems = [];
      updateBadgeCounts();
      closeAllModals();
      switchScreen('tracking');
    ...
    submitOfficialRfq: function () {
      showToast(`Quotation Request transmitted to Sales Account Manager ${state.activeCustomer.accountMgr}! Commercial Opportunity logged to CRM (System 05).`, 'teal');
      state.quoteItems = [];
      updateBadgeCounts();
      closeAllModals();
    },
    ...
    initEventListeners: function () {
      ...
      document.querySelectorAll('.filter-checkbox-input').forEach(input => {
        input.addEventListener('change', (e) => {
          ...
          if (type === 'availability') window.shopApp.toggleAvailabilityFilter(val);
