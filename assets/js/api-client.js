...
(function (global) {
  ...
  const crm = {
    ...
    createOpportunity(payload) {
      return call("/crm/opportunities.php", { method: "POST", body: payload });
    },
    forecasts(params = {}) {
  ...
  const shop = {
    ...
    placeOrder(payload) {
      return call("/shop/orders.php", { method: "POST", body: payload });
    },
    orders(params = {}) {
    ...
    requestQuote(payload) {
      return call("/shop/quotes.php", { method: "POST", body: payload });
    },
  };
  ...
  const customer = {
    ...
    submitTicket(payload) {
      return call("/customer/tickets.php", { method: "POST", body: payload });
    },
  };
  ...
  const intranet = {
    ...
    submitLeave(payload) {
      return call("/intranet/leaves.php", { method: "POST", body: payload });
    },
  };
  ...
  const i18n = {
    ...
    set(lang) {
      ...
      document.dispatchEvent(
        new CustomEvent("vp:langchange", { detail: lang }),
      );
    },
    toggle() {
