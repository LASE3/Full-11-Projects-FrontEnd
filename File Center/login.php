  ...
  <script>
    document.addEventListener('DOMContentLoaded', () => {
      ...
      loginForm.addEventListener('submit', (e) => {
        ...
        if (!userId) {
          showAlert('Please enter your Custodian ID (e.g. CST-VP-09).');
          userIdInput.focus();
          return;
        }

        if (!password) {
          showAlert('Please enter your vault security password.');
          passwordInput.focus();
          return;
        }
        ...
        .then(async (res) => {
          ...
          if (res.ok && data.success) {
            ...
            try {
              ...
              sessionStorage.setItem('vp_vault_user', JSON.stringify(data.user || {
                userId: userId,
                role: 'custodian',
                system: 'SYS-07'
              }));
