<?php
/**
 * VOSTOKPRIBOR File Center (SYS06) - Inter-System Integrations & Data Bus
...
<head>
    ...
    <title>VOSTOKPRIBOR File Center · Inter-System Integrations (SYS06)</title>
...
<body>
    ...
    <header class="vostok-top-bar">
        <a href="Dashboard.php" class="vostok-brand-link">
            ...
            <div style="display: flex; flex-direction: column;">
                ...
                <span style="font-family: 'JetBrains Mono', monospace; font-size: 0.65rem; color: #00E5FF;">File Center &bull; SYS06</span>
            </div>
        </a>
        ...
        <div class="vostok-nav-actions">
            ...
            <a href="../api/logout.php?redirect=../File Center/login.php" class="vostok-btn-back" style="color: #F87171; border-color: rgba(239,68,68,0.3);">
    ...
    <main class="vostok-main-content">
        <?php renderSystemIntegrationView('SYS06', 'standalone'); ?>
    </main>
