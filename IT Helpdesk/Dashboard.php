...
if (empty($_SESSION['vostok_authenticated']) || empty($_SESSION['vostok_system_IT'])) {
      ...
      <aside class="sidebar">
        <div>
          ...
          <nav class="sidebar-nav" style="margin-bottom: 0.5rem;">
            ...
            <!-- Log Out -->
            <a href="../api/logout.php?system=IT%20Helpdesk&redirect=../IT%20Helpdesk/login.php" class="sidebar-nav-item sidebar-nav-item--logout" id="btn-logout" onclick="(function(){sessionStorage.clear();localStorage.clear();})()" onclick="(function(){sessionStorage.clear();localStorage.clear();})()">
              <div class="sidebar-item-left">
                <span class="sidebar-icon">
            ...
            <div class="needs-attention-list">
              ...
              <div class="attention-item">
                <div style="display: flex; align-items: center; gap: 1rem;">
                  <div style="display: flex; flex-direction: column; align-items: center; justify-content: center; min-width: 80px;">
                    ...
                    <span style="font-family: var(--hd-font-mono); font-size: 10.5px; color: var(--hd-priority-critical); font-weight: 700; margin-top: 3px;">01:42:15 Left</span>
                  </div>
                  <div>
                    <div style="display: flex; align-items: center; gap: 0.5rem;">
                      <a href="TicketDetail.php" style="font-size: 13.5px; font-weight: 700; color: var(--hd-navy); text-decoration: none;">
              ...
              <div class="attention-item">
                <div style="display: flex; align-items: center; gap: 1rem;">
                  <div style="display: flex; flex-direction: column; align-items: center; justify-content: center; min-width: 80px;">
                    <span class="priority-badge priority-critical">CRITICAL</span>
                    <span style="font-family: var(--hd-font-mono); font-size: 10.5px; color: var(--hd-priority-critical); font-weight: 700; margin-top: 3px;">00:48:30 Left</span>
                  </div>
                  <div>
                    <div style="display: flex; align-items: center; gap: 0.5rem;">
                      <a href="TicketDetail.php" style="font-size: 13.5px; font-weight: 700; color: var(--hd-navy); text-decoration: none;">
              ...
              <div class="attention-item warning-tier">
                <div style="display: flex; align-items: center; gap: 1rem;">
                  <div style="display: flex; flex-direction: column; align-items: center; justify-content: center; min-width: 80px;">
                    ...
                    <span style="font-family: var(--hd-font-mono); font-size: 10.5px; color: var(--hd-orange); font-weight: 700; margin-top: 3px;">02:15:00 Left</span>
                  </div>
                  <div>
                    <div style="display: flex; align-items: center; gap: 0.5rem;">
                      <a href="TicketDetail.php" style="font-size: 13.5px; font-weight: 700; color: var(--hd-navy); text-decoration: none;">
