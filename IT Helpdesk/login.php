...
<head>
  ...
  <meta name="description"
    content="VOSTOKPRIBOR IT Helpdesk - Technical support portal, ticket queues, hardware telemetry, and infrastructure maintenance.">
  <title>IT Support Portal Login · VOSTOKPRIBOR SYS-08</title>
...
<body>
  ...
  <header class="auth-top-bar">
    <a href="index.php" class="auth-brand-link" title="Return to Helpdesk Portal">
      <img
        src="assets/logo.svg"
      ...
      <span class="auth-system-tag">SYS-08 // HELPDESK</span>
    </a>
    <div class="auth-status-beacon" title="Service Desk Telemetry Active">
      <span class="status-dot-pulse"></span>
      <span>IT NOC ACTIVE · 0 CRITICAL INCIDENTS</span>
    </div>
  </header>
  ...
  <main class="auth-main">
    <section class="auth-card" aria-labelledby="login-heading">
      ...
      <div class="auth-card-body">
        <header class="auth-card-header">
          <div class="auth-class-badge">
            ...
            <span>IT Helpdesk Class</span>
          </div>
          <h1 id="login-heading" class="auth-card-title">IT Support Portal Login</h1>
          <p class="auth-card-subtitle">Manage technical support tickets, asset queues, and infrastructure incidents.
          </p>
        </header>
        ...
        <form id="login-form" data-recovery-msg="Contact VP Infrastructure &amp; Support Admin for account recovery." class="auth-form" action="../api/auth.php" method="POST" novalidate>
          <input type="hidden" name="systemId" value="IT">
          <input type="hidden" name="redirect" value="Dashboard.php">
          <div class="form-group">
            <label for="userId" class="form-label">
              <span>Support Tech ID</span>
            ...
            <div class="input-container">
              ...
              <input type="text" id="userId" name="userId" class="form-input" placeholder="IT-VP-304"
      ...
      <footer class="auth-card-footer">
        ...
        <span>ID: VP-HELPDESK-02</span>
      </footer>
    </section>
  </main>

  <footer class="auth-page-footer">
    <p>&copy; 2026 VOSTOKPRIBOR Industrial Group · Technical Support Operations · helpdesk.vostokpribor.local</p>
  </footer>
