    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        if (submitBtn && keysTbody) {
            submitBtn.addEventListener('click', () => {
                ...
                const label = labelInput ? labelInput.value.trim() || 'Custom Enterprise Service' : 'Custom Enterprise Service';
        ...
        document.addEventListener('click', (e) => {
            ...
            if (btn) {
                ...
                if (tr) {
                    ...
                    window.showToast('KEY REVOKED', 'Cryptographic access token invalidated across all regional gateways.', 'warn', 'link_off');
                }
            }
        });
    });
