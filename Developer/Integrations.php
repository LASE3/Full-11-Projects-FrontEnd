<?php
/**
 * VOSTOKPRIBOR Developer Portal (SYS04) - Inter-System Integrations & Data Bus
...
<head>
    ...
    <title>VOSTOKPRIBOR Developer Portal · Inter-System Integrations (SYS04)</title>
...
<body>
    ...
    <header class="vostok-top-bar">
        <a href="Dashboard.php" class="vostok-brand-link">
            ...
            <div style="display: flex; flex-direction: column;">
                ...
                <span style="font-family: 'JetBrains Mono', monospace; font-size: 0.65rem; color: #00E5FF;">Developer Portal &bull; SYS04</span>
            </div>
        </a>
        ...
        <div class="vostok-nav-actions">
            ...
            <a href="../api/logout.php?redirect=../Developer/login.php" class="vostok-btn-back" style="color: #F87171; border-color: rgba(239,68,68,0.3);">
    ...
    <main class="vostok-main-content">
        <?php renderSystemIntegrationView('SYS04', 'standalone'); ?>
    </main>
