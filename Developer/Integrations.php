    ...
    <header class="vostok-top-bar">
        <a href="Dashboard.php" class="vostok-brand-link">
            ...
            <div class="vostok-brand-title">
                ...
                <span class="vostok-brand-system">Developer Portal &bull; SYS04</span>
            </div>
        </a>
        ...
        <div class="vostok-nav-actions">
            ...
            <a href="../api/logout.php?redirect=../Developer/login.php" class="vostok-btn-back vostok-btn-signout">
