...
<head>
    ...
    <title>VOSTOKPRIBOR Corporate Web Platform · Inter-System Integrations (SYS11)</title>
...
<body>
    ...
    <header class="vostok-top-bar">
        <a href="index.php" class="vostok-brand-link">
            ...
            <div style="display: flex; flex-direction: column;">
                ...
                <span style="font-family: 'JetBrains Mono', monospace; font-size: 0.65rem; color: #00E5FF;">Corporate Web Platform &bull; SYS11</span>
            </div>
        </a>
        ...
        <div class="vostok-nav-actions">
            ...
            <a href="../api/logout.php?redirect=../VOSTOKPRIBOR Corporate Web Platform/login.php" class="vostok-btn-back" style="color: #F87171; border-color: rgba(239,68,68,0.3);">
    ...
    <main class="vostok-main-content">
        <?php renderSystemIntegrationView('SYS11', 'standalone'); ?>
    </main>
