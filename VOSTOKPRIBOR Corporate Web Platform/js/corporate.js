...
(function () {
  ...
  const PRODUCT_CATALOG = {
    "PROD-1001": {
      ...
      description:
        "Multi-spectral pyrometric and optical inspection sensors designed for severe metallurgical furnaces, hot strip mills, and chemical processing skids.",
      specs: {
    ...
    "PROD-1002": {
      ...
      description:
        "Sub-millimeter total station and RTK GNSS bundle for large-scale geodetic infrastructure surveys, dam deformation monitoring, and railway track alignment.",
      specs: {
    ...
    "PROD-1003": {
      ...
      description:
        "Robotic multi-parameter sensor calibration bench with automated certificate generation and Crypto-Pro EDS digital signing compliance.",
      specs: {
        ...
        "Compliance Engine":
          "Automated Rosstandart & ISO 17025 report generator",
        "Safety Interlocks": "SIL 2 Dual-Channel Emergency Shutdown",
      },
      primaryApplication:
        "Vostokpribor Metrology Labs, Central Plant Quality Labs",
    },
    "PROD-1004": {
      id: "PROD-1004",
      category: "automation",
      ...
      description:
        "Custom programmable automation rack designed for deterministic telemetry loop control, emergency safety sequencing, and SCADA uplink.",
      specs: {
      ...
      primaryApplication:
        "Tashkent Precision Controls, BaltNord Process Systems",
    },
    "PROD-1005": {
      id: "PROD-1005",
      category: "automation",
      ...
      description:
        "Rugged DIN-rail edge computing unit bridging localized RS-485/Modbus field nodes to the centralized Vostokpribor Customer Telemetry Cloud.",
      specs: {
    ...
    "PROD-1006": {
      ...
      description:
        "High-speed line-scan camera array with automated machine vision AI for micro-defect detection in cold-rolled steel and aluminum extrusion lines.",
      specs: {
    ...
    "PROD-1007": {
      ...
      description:
        "Comprehensive 24/7 engineering warranty, guaranteed 2-hour technician dispatch, emergency parts hot-swapping, and quarterly metrology audit.",
      specs: {
        "SLA Response Time": "Under 15 Minutes to First Engineering Triage",
        "On-Site Mezzanine Support":
          "Guaranteed 4-hour on-site industrial tech",
        "Firmware Maintenance":
          "Over-the-air hotfixes and patch certifications",
        "Dedicated Account Rep":
          "Assigned Senior Systems Engineer (e.g. Viktor Morozov)",
      },
      primaryApplication:
        "Tier-1 Industrial Accounts (Severstal, Steppe Mining)",
    },
    "PROD-1008": {
      id: "PROD-1008",
      category: "automation",
      ...
      description:
        "Modular enterprise middleware connecting legacy SCADA installations (Siemens S7, Rockwell, Schneider) directly to ERP, CRM, and Billing.",
      specs: {
    ...
    "PROD-1009": {
      ...
      description:
        "Specialized bonded warehousing, temperature-monitored sensitive instrument transit, and customs brokerage across Central Asia and Europe.",
      specs: {
    ...
    "PROD-1010": {
      ...
      description:
        "Annual scheduled optical alignment, sensor zero-drift calibration, laser diode replacement, and state metrological recertification.",
      specs: {
      ...
      primaryApplication:
        "Daugava Optical Research, Caspian Industrial Robotics",
    },
  };
  ...
  function renderProductCards(category) {
    ...
    filtered.forEach((item) => {
      ...
      const classificationLabel =
        item.classification === "internal" ? "Internal" : "Public";
  ...
  function openSpecModal(productId) {
    ...
    modalClassBadge.textContent =
      product.classification === "internal" ? "Internal" : "Public";
    ...
    form.addEventListener("submit", function (e) {
      ...
      if (
        ...
        showCorporateToast(
          ...
          "Please fill in your company, contact name, and business email.",
          "error",
        );
        return;
      }
