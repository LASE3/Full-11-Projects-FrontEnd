    ...
    <header class="corporate-header">
        <div class="max-w-[1440px] mx-auto h-full px-4 sm:px-6 lg:px-8 flex items-center justify-between gap-4">
            ...
            <div class="flex items-center gap-2.5 sm:gap-3 shrink-0">
                ...
                <!-- Portal Login Button -->
                <a href="login.php"
                    class="inline-flex items-center gap-1 px-3 py-1.5 rounded bg-white/10 hover:bg-white/20 text-white font-medium text-xs border border-white/20 transition-colors cursor-pointer whitespace-nowrap"
                    title="Portal Gateway Login">
