                        ...
                        <div class="flex items-start justify-between">
                            <div class="flex flex-col">
                                <span
                                    ...
                                    Projects</span>
                                <span
                                    class="font-display-lg text-display-lg text-primary font-bold tracking-tight mt-unit-xs">14</span>
                            </div>
                        ...
                        <div class="flex items-start justify-between pl-unit-xs">
                            <div class="flex flex-col">
                                <span
                                    ...
                                    Invoices</span>
                                <span
                                    class="font-display-lg text-display-lg text-primary font-bold tracking-tight mt-unit-xs">3</span>
                            </div>
                    ...
                    <a href="SupportTicketView.php?ticket=TCK-9482"
                        ...
                        <div class="flex items-start justify-between">
                            <div class="flex flex-col">
                                ...
                                <span
                                    class="font-display-lg text-display-lg text-primary font-bold tracking-tight mt-unit-xs">5</span>
                            </div>
