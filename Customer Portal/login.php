...
<head>
  ...
  <meta name="description" content="VOSTOKPRIBOR Customer Portal - Client service login, telemetry monitoring, service tracking, and support ticket management.">
  <title>Customer Service Login · VOSTOKPRIBOR SYS-09</title>
...
<body>
  ...
  <header class="auth-top-bar">
    <a href="index.php" class="auth-brand-link" title="Return to Customer Portal">
      <img src="https://lh3.googleusercontent.com/aida/AEtjO1XMGDZ9meLzj0XkVJ6C4Xv2AoEzKtMyFqF7KQ8eMADmbywzsRZ7VF4Em6pQ7fZ8QRJExCZedCKEUUo1fN1LpEmGsQva25blyUsGhOPvX2vv2cHGkppzOp9iT33Xy2n4Nkr5e_YY_0J78vA8Q7vKUpViCouPJo13HFVvW5olf7QEFzU3EX-WCqc0SYyPXZb7E11PafOMC_KprpG6Tre6bN_DyZS-CI-J5qiCgBtikqVNYGueATNgWbi73Q"
           alt="VOSTOKPRIBOR Logo" class="auth-brand-logo">
      <div>
        <div class="auth-brand-name">VOSTOKPRIBOR</div>
      </div>
      <span class="auth-system-tag">SYS-09 // CLIENT</span>
    </a>
    <div class="auth-status-beacon" title="Client Gateway Active">
      <span class="status-dot-pulse"></span>
      <span>CLIENT PORTAL GATEWAY · 99.99%</span>
    </div>
  </header>
  ...
  <main class="auth-main">
    <section class="auth-card" aria-labelledby="login-heading">
      ...
      <div class="auth-card-body">
        <header class="auth-card-header">
          <div class="auth-class-badge">
            ...
            <span>Customer Portal Class</span>
          </div>
          <h1 id="login-heading" class="auth-card-title">Customer Service Login</h1>
          <p class="auth-card-subtitle">Access your account, track active orders, and submit technical requests.</p>
        </header>
        ...
        <form id="login-form" class="auth-form" action="../api/auth.php" method="POST" novalidate>
          ...
          <div class="form-group">
            ...
            <div class="input-container">
              ...
              <input type="text" id="userId" name="userId" class="form-input"
                     placeholder="CLT-77210" autocomplete="username" required autofocus>
            </div>
          </div>
          ...
          <button type="submit" id="submit-btn" class="auth-submit-btn">
            ...
            <span class="btn-text">Log In as Customer</span>
          </button>
      ...
      <footer class="auth-card-footer">
        ...
        <span>ID: VP-PORTAL-09</span>
      </footer>
    </section>
  </main>

  <footer class="auth-page-footer">
    <p>&copy; 2026 VOSTOKPRIBOR Industrial Group · Client Self-Service Gateway · portal.vostokpribor.local</p>
  </footer>
  ...
  <script>
    document.addEventListener('DOMContentLoaded', () => {
      ...
      loginForm.addEventListener('submit', (e) => {
        ...
        if (!userId) {
          showAlert('Please enter your Client / Account ID (e.g. CLT-77210).');
          userIdInput.focus();
          return;
        }
        ...
        .then(async (res) => {
          ...
          if (res.ok && data.success) {
            ...
            try {
              ...
              sessionStorage.setItem('vp_client_user', JSON.stringify(data.user || {
                userId: userId,
                role: 'customer',
                system: 'SYS-09'
              }));
      ...
      window.fillDemoCredentials = function() {
        userIdInput.value = 'CLT-77210';
        passwordInput.value = 'ClientPass2026!';
        hideAlert();
      };

      window.handleForgotCredentials = function() {
        showAlert('Security Advisory: Contact your dedicated VP Client Representative for account recovery.', true);
      };
    });
  </script>
</body>
